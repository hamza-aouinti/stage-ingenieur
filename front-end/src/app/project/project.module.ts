...
@NgModule({
  declarations: [AddProjectComponent, EditProjectComponent, DeleteProjectComponent, DetailsProjectComponent, AddTaskComponent, EditTaskComponent, DeleteTaskComponent, ListTaskComponent, ListProjectComponent, AddPhaseComponent, EditPhaseComponent, DeletePhaseComponent, ListPhaseComponent, BoardPhaseComponent, AddUserProjectComponent, AddChildTaskComponent, TrailTaskComponent, TrailProjectComponent],
  imports: [
    CommonModule,
