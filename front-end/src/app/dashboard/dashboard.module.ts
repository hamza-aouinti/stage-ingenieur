...
@NgModule({
  declarations: [HomeDashboardComponent, TrackerListProjectsComponent, ListUsersComponent, ProgressTasksProjectComponent, CardsProjectComponent, ProgressUsersProjectComponent, DepartmentListUsersComponent, StatusListProjectsComponent, CardsGeneralStatisticsComponent],
  imports: [
    CommonModule,
